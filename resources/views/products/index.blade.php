...
<style>
    ...
    /* Sticky filter toggle button on mobile */
    ...
    /* Style for filter collapse panel */
    #filterFormCollapse {
        background: #fff;
...
<div class="container py-5">
    ...
    {{-- Mobile Filter Toggle Button (nav style) --}}
    <nav class="navbar navbar-light bg-light d-md-none mb-3 shadow-sm rounded sticky-filter-btn">
        <div class="container-fluid px-0">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#filterFormCollapse" aria-controls="filterFormCollapse" aria-expanded="false" aria-label="Toggle Filters">
